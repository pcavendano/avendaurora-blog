    ...
    <div class="footer__container">
        <div class="footer__grid">
            ...
            <div class="footer__brand">
                ...
                <p class="footer__tagline"><?= $site->site_tagline() ?></p>
            ...
            <div class="footer__links">
                ...
                <ul>
                    ...
                    <li><a href="<?= url('recetas') ?>?category=sopas-caldos"><?= t('category.sopas-caldos') ?></a></li>
                    <li><a href="<?= url('recetas') ?>?category=postres"><?= t('category.postres') ?></a></li>
                </ul>
            </div>
            ...
            <!-- Newsletter -->
            <?php if ($site->show_newsletter()->toBool()): ?>
            <div class="footer__newsletter">
                <h4 class="footer__title"><?= $site->newsletter_title()->or(t('footer.newsletter')) ?></h4>
                <p><?= $site->newsletter_text() ?></p>
                <form class="newsletter-form" action="#" method="post">
                    <input type="email" name="email" placeholder="<?= t('footer.newsletter_placeholder') ?>" required>
        ...
        <div class="footer__bottom">
            <p><?= $site->copyright()->or(t('footer.copyright')) ?></p>
